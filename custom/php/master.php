                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">OK2Save</a></li>
   ...
   if ($type=="adminfees") {
    ...
    $query1=mysqli_query($link,"SELECT * FROM fees where  rank='2'");
      $query12=mysqli_query($link,"SELECT * FROM fees where  name='Loan'");
           $query13=mysqli_query($link,"SELECT * FROM fees where  name='card fee'");
              $query14=mysqli_query($link,"SELECT * FROM fees where  name='savings'");
             
              
              $query290=mysqli_query($link,"SELECT * FROM fees where  name='investment'");
     ?>
 <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
...
">
                             ...
                             <div class="col-sm-6">
                                <p><b>Investments return (%)</b></p>
                                <div class="p-4 card">
                                    <?php 
                                    while($rii44=mysqli_fetch_array($query290)){
                                        ?>
                                        <div class="row mb-3">
                                        <div class="col-6">
                                            <p>  <?php  echo $rii44['name'] ?> |   <?php  echo $rii44['rank'] ?> </p>
                                        </div>
                                         <div class="col-6">
                                            <input type="text" name="" class="form-control" value="<?php  echo $rii44['fee'] ?>"  oninput="
updfee(this.value,'<?php echo $rii44['id']  ?>');
">
                                        </div>

                                        <div class="col-6 mt-3">
                                          <input type="text" name="" class="form-control" value="<?php  echo $rii44['min'] ?>"  oninput="
updfee1(this.value,'<?php echo $rii44['id']  ?>');
"> <small> Minimum amt</small>
                                        </div>

                                         <div class="col-6 mt-3">
                                          <input type="text" name="" class="form-control" value="<?php  echo $rii44['max'] ?>"  oninput="
updfee2(this.value,'<?php echo $rii44['id']  ?>');
"> <small> Maximum amt</small>
                                        </div>
                                         <div class="col-6 mt-3">
                                          <input type="text" name="" class="form-control" value="<?php  echo $rii44['duration'] ?>"  oninput="
updfee3(this.value,'<?php echo $rii44['id']  ?>');
...
">
                                         ...
                                         <div class="col-6 mt-3">
                                            <input type="text" name="" class="form-control" value="<?php  echo $rii4['min'] ?>"  oninput="
updfee1(this.value,'<?php echo $rii4['id']  ?>');
"> <small>Minimum amt</small>
                                        </div>

                                         <div class="col-6 mt-3">
                                            <input type="text" name="" class="form-control" value="<?php  echo $rii4['max'] ?>"  oninput="
updfee2(this.value,'<?php echo $rii4['id']  ?>');
"><small>Maximum amt</small>
                                        </div>
...
mysqli_query($link,"UPDATE fees set fee='$new' where id='$id'");
   ...
   if ($type=="adminupdfee1") {
     $new=$_POST['new'];
     $id=$_POST['id'];
mysqli_query($link,"UPDATE fees set min='$new' where id='$id'");
   }

   if ($type=="adminupdfee2") {
     $new=$_POST['new'];
     $id=$_POST['id'];
mysqli_query($link,"UPDATE fees set max='$new' where id='$id'");
   }

   if ($type=="adminupdfee3") {
     $new=$_POST['new'];
     $id=$_POST['id'];
mysqli_query($link,"UPDATE fees set duration='$new' where id='$id'");
   }
   if ($type=="admindata") {
...
$query1=mysqli_query($link,"SELECT * FROM balances where balance='nairab' and email='$phone1'");
 while($de1=mysqli_fetch_array($query1)){
                                                        ...
                                                        <td><?php  echo $de['last_name'] ?></td>
                                                          ...
                                                          <td><?php  echo $de['email'] ?></td>
                                                           ...
                                                           <td><?php  echo $de['rank'] ?></td>
                                                            <td><?php  echo $ba ?></td>
                                                           <td><input type="text" name="" class="me-3" id="nbm"> <button class="btn btn-primary" onclick="fundu(document.getElementById('nbm').value,this,'<?php  echo $de['email'] ?>')">Fund</button></td>

                                                            <td><input type="text" name="" class="me-3" id="nbm1"> <button class="btn btn-danger" onclick="fundu1(document.getElementById('nbm1').value,this,'<?php  echo $de['email'] ?>')"> Debit</button></td>

                                                               <td><button class="btn btn-danger" onclick="delu('',this,'<?php  echo $de['email'] ?>')"> Delete user</button></td>
...
mysqli_query($link,"UPDATE balances set amount= amount + $amt where email ='$id' and balance='nairab'");
}
if ($type=="fundu1") {
 $amt=$_POST['amt'];
  $id=$_POST['id'];
...
mysqli_query($link,"DELETE FROM balances where email='$id'");
mysqli_query($link,"DELETE FROM users where email='$id'");
...
$query=mysqli_query($link,"SELECT * FROM investments order by id desc");
$row1=mysqli_num_rows($query);
    ?>
 <div class="row">
                            <div class="col-12">
